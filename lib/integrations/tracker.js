...
var STORY_STATES = ["started", "finished", "delivered", "accepted", "unstarted"]
...
opts.stories = function(parser) {
  parser.options({ "type": { "abbr": "t"
                            , "help": "The type of the story"
                            , "choices": STORY_TYPES
                            }
                  , "current_state": { "abbr": "s"
                                     , "full": "state"
                                     , "help": "The current state of the story"
                                     , "choices": STORY_STATES
                                     }
                  , "label": { "abbr": "l"
                             , "help": "A label that appears on the story"
                             }
                  , "includedone": { "abbr": "d"
                                   , "full": "done"
                                   , "flag": true
                                   , "help": "Include accepted stories in the results"
                                   }
                  , "requested_by": { "abbr": "r"
                                    , "full": "requester"
                                    , "help": "Full name of the user who requested the story"
                                    }
                  });
};
...
opts.add_task = function(parser) {
  parser.options({ "story_id": common_options.story_id
                 , "description": { "position": 1
                                  , "help": "Description of task to be added"
                                  , "required": true
                                  }
                 });
};
commands.add_task = function(opts) {
  error_catcher(pivotal.addTask, [project_id, opts.story_id, { "description": opts.description }], function() {
