...
var public_methods = {
  ...
  "show": function() {
    var story_id = utilities.get_next_arg();
  ...
  "estimate": function() {
    update_story(utilities.get_next_arg(), { "estimate": utilities.get_next_arg() }, function(res) {
  ...
  "schedule": function() {
    schedule_story(utilities.get_next_arg(), function() {
...
// functions to the public_methods hash.
//
// ### Updating:
...
_.each(["start", "finish", "deliver", "accept", "unstart"], function(verb) {
  public_methods[verb] = function() {
    update_story(utilities.get_next_arg(), { current_state: participle }, function(res) {
      console.log("Story \"" + res.name + "\" has been " + participle);
    });
  };

  var participle = verb + "ed"
  public_methods[participle] = function() {
