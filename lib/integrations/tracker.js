...
commands.setup = function() {
  ...
  utilities.username_and_password_prompt(function(result) {
    error_catcher(pivotal.getToken, [result.username, result.password], function(res) {
      utilities.write_user_data("tracker", { "token": res.guid }, function(err) {
        if (err) {
...
commands.todo = function() {
  error_catcher(pivotal.getCurrentIteration, [project_id], function(current_res) {
    ...
    error_catcher(pivotal.getBacklogIterations, [project_id, null], function(backlog_res) {
...
commands.backlog = function() {
  error_catcher(pivotal.getBacklogIterations, [project_id, null], function(res) {
...
function print_status_table(stories) {
